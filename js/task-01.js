...
// цена: 1000
// Используя шаблонную строку и переменные name и price задай новой 
// переменной firstMessage текст:
...
// Мое решение - я думаю назва переменной не может быть просто name
// const nameGenerator = 'Генератор защитного поля';
