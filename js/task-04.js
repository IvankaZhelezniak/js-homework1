...
// Единица товара (дроида) стоит 3000 кредитов за штуку и это значение хранится 
// в переменной pricePerDroid.
...
// Используйте вспомогательную переменную balanceCredit, которая принимает 
// разницу между credits и totalPrice.
...
// ЮЮЮХХХУУУУ.  ЗАДАЧКА РЕШЕНА УРАААААААААА
